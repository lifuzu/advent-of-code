...
if (require.main === module) {
  ...
  let input = `ne,ne,ne`
  let output = grid.steps(input)
  console.log(output)
  assert.equal(output, 3)

  input = `ne,ne,sw,sw`
  output = grid.steps(input)
  console.log(output)
